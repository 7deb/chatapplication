...
const ChatContainer = () => {
  ...
  }, [selectedUser?._id, getMessages, authUser,subscribeMessage,unsubscribeMessage]);
          ...
          messages.map((message, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`chat-bubble flex flex-col ${isCurrentUser ? "bg-blue-600" : "bg-gray-600"
                  } text-white`}>
                  {message.image && (
                    <img
                      src={message.image}
